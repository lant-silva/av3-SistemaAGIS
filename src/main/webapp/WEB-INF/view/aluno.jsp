		...
		<div align="center" class="container">
			<form action="aluno" method="post">
				<table>
					...
					<tr>
						<td><label for="pontuacaoVestibular">Pontuação Vestibular:</label></td>
					...
					<tr>
						<td><label for="posicaoVestibular">Posição Vestibular:</label></td>
						<td colspan="4"><input class="input_data" type="number"
					...
					<tr>
						<td><label for="semestreGraudacao">Semestre Graduação:</label></td>
						<td colspan="4"><input class="input_data" type="text"
